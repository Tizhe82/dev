...
export default function Home() {
  useEffect(() => {
    document.title =
      "Tizhe Paul | Full Stack Developer ";
    ...
    <>
      <div className="container home-page">
        ...
        <div className="text-zone">
          <h1
            aria-label=" Hi, I’m Tizhe,web developer."
          ...
          <h2>Full Stack | Frontend Developer </h2>
          <div className="icons">
            <a href="https://twitter.com/tizzleflixx" target="_blank" >
              <i className="fab fa-twitter fa-3x"></i>
            </a>
            <a href="https://github.com/Tizhe82" target="_blank" >
              <i className="fab fa-github fa-3x"></i>
            </a>
            <a href="https://discord.gg/tizhepaul" target="_blank" >
